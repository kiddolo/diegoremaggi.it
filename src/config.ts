...
import avatarImg from './assets/images/site/avatar-diegoremaggi.png';
import ogDefaultImg from './assets/images/site/og-default-diegoremaggi.jpg';
...
export const SITE: SiteConfig = {
  ...
  description: 'Blog personale e analisi OSINT su guerre, operazioni di influenza e propaganda.',
  /** Author/handle shown in footer + meta. */
  author: {
    name: 'Diego Remaggi',
    url: GITHUB_HANDLE ? `https://github.com/${GITHUB_HANDLE}` : undefined,
    avatar: avatarImg,
    bio: 'Giornalista OSINT · Guerre, operazioni di influenza e propaganda',
  },
  /** Default OG image. */
...
export const NAV: readonly NavItem[] = [
  ...
  { key: 'about', href: '/chi-sono', icon: 'lucide:info' },
] as const;
